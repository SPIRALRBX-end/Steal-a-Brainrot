...
local UICorner_3_1 = Instance.new('UICorner')
...
ToggleBT.Position = UDim2.new(0.061642, 0, 0.211964, 0)
ToggleBT.Size = UDim2.new(0.244957, 0, 0.148085, 0)
ToggleBT.Visible = false
ToggleBT.Font = Enum.Font.SourceSans
ToggleBT.Text = ""
ToggleBT.TextColor3 = Color3.new(0.000000, 0.000000, 0.000000)
ToggleBT.TextSize = 14.000000
ToggleBT.Parent = Frame_1
UIStroke_5.Name = "UIStroke_5"
...
UIStroke_5.Parent = ToggleBT
Boll.BackgroundColor3 = Color3.new(1.000000, 1.000000, 1.000000)
Boll.BorderColor3 = Color3.new(0.000000, 0.000000, 0.000000)
Boll.BorderSizePixel = 0.000000
Boll.Name = "Boll"
Boll.Position = UDim2.new(0.020000, 0, 0.018000, 0)
...
UICorner_11.Parent = Boll
UIAspectRatioConstraint_2.Name = "UIAspectRatioConstraint_2"
...
ToggleBT_1.Position = UDim2.new(0.042385, 0, -0.041183, 0)
...
ToggleBT_1.Parent = BrainrotGodFR
Animations.Name = "Animations"
Animations.Parent = ToggleBT_1
...
Boll_1.Size = UDim2.new(0.519000, 0, 0.962000, 0)
...
UIAspectRatioConstraint.Parent = Boll_1
UICorner_2.Name = "UICorner_2"
UICorner_2.CornerRadius = UDim.new(0.000000, 85)
UICorner_2.Parent = Boll_1
UIStroke_1.Name = "UIStroke_1"
...
UICorner_3_1.Name = "UICorner_3"
UICorner_3_1.CornerRadius = UDim.new(0.000000, 8)
UICorner_3_1.Parent = TextLabel_2
...
ToggleBT_2.Position = UDim2.new(0.042385, 0, -0.026677, 0)
ToggleBT_2.Size = UDim2.new(0.220000, 0, 0.380000, 0)
...
ToggleBT_2.Parent = BrainrotSecret
...
Boll_2.Name = "Boll"
Boll_2.Position = UDim2.new(0.050000, 0, 0.018000, 0)
Boll_2.Size = UDim2.new(0.518773, 0, 0.962248, 0)
Boll_2.Parent = ToggleBT_2
UIAspectRatioConstraint_1.Name = "UIAspectRatioConstraint_1"
...
local function LocalScript_generatedScript()
    ...
    local selected = {}            -- sua tabela de selecionados
    local targetNames = {}         -- nomes ativos para o auto-buy
    local targetNamesCache = {}    -- cache para busca
    ...
    local function updateTargetNames()
    	...
    	-- ahazendo cache de lowercase (se precisar)
    	targetNamesCache = {}
    	for i, name in ipairs(targetNames) do
    		targetNamesCache[i] = { original = name, lower = name:lower() }
    	end
    	-- Se não sobrar nenhum selecionado, para tudo
    	if #targetNames == 0 and AUTO_ACTIVATE then
    		AUTO_ACTIVATE = false
    		-- chama exatamente as suas funções de parada
    		stopScript()
    		stopDrag()
    	end
    end
    ...
    local function populateScrolling()
    	...
    	for _, name in ipairs(availableNames) do
    		...
    		local rarityText  = ('<font color="%s">%s</font>'):format(rarityInfo.color, rarityInfo.text)
    		-- função única pra tudo: define cor, transparência e texto
    		local function refreshBtnAppearance()
    			local icon = selected[name] and "?" or "?"
    			btn.BackgroundTransparency = selected[name] and 0.7 or 0.35
    			btn.BackgroundColor3      = selected[name]
    				and Color3.fromRGB(0,150,0)
    				or Color3.new(0,0,0)
    			btn.Text = ('<font size="12">%s %s - %s</font>'):format(icon, name, rarityText)
    		end
    		-- primeira vez
    		...
    		btn.MouseButton1Click:Connect(function()
    			...
    			saveSelectedNames()
    			-- 2) atualiza UI (botões + contagem/toggle)
    			refreshBtnAppearance()
    			updateCompleteUI()
    			updateButtonAppearance()
    			-- 3) atualiza lista de targets e, se for o caso, reinicia o auto-buy
    			updateTargetNames()
    			if AUTO_ACTIVATE then
    				stopScript()
    				wait(0.1)
    	...
    	-- reajusta CanvasSize
    	scrollingFR.CanvasSize = UDim2.new(0, 0, 0, #availableNames * 32)
    end
    ...
    toggleBtn.MouseButton1Click:Connect(function()
    	if not SCRIPT_LOADED then
    		toggleBtn.Text = "?? WAIT FOR LOADING!"
