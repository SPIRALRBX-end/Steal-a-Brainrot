...
local function startDrag()
	...
	dragConnection = RunService.Heartbeat:Connect(function()
		if DRAG_ACTIVE and bodyPosition and humanoidRootPart then
...
local function populateScrolling()
	...
	for _, name in ipairs(availableNames) do
		...
		if selected[name] then
			...
			btn.Text = '🟢 <font size="14"></font> ' .. name .. '       <font size="14">' .. rarityText .. '</font>'
		else
